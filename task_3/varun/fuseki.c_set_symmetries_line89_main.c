...
#include <fuseki.c_set_symmetries_line89_1.h>
#include <common.h>
#include <timer.h>
...
int i;
int board_size;
int vertically_symmetric;
int horizontally_symmetric;
int diagonally_symmetric;
int j;
...
int main(int argc, char** argv)
{
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        /*----------------- read data for board----------------------*/
        char board_dataFileName[] = "/dataFile/fuseki.c_set_symmetries_line89_1.board.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/fuseki.c_set_symmetries_line89_1.board.dat does not exist!");
                exit(-1);
            }
        ...
        memcpy(&diagonally_symmetric, &diagonally_symmetric_, sizeof(diagonally_symmetric_));
        memcpy(&horizontally_symmetric, &horizontally_symmetric_, sizeof(horizontally_symmetric_));
        memcpy(&vertically_symmetric, &vertically_symmetric_, sizeof(vertically_symmetric_));
    ...
    printf("\n");
    printf("Scalar j: %d\n", j);
    printf("Scalar diagonally_symmetric: %d\n", diagonally_symmetric);
    printf("Scalar horizontally_symmetric: %d\n", horizontally_symmetric);
    printf("Scalar vertically_symmetric: %d\n", vertically_symmetric);
    printf("Scalar i: %d\n", i);
