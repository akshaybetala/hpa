...
#include <readconnect.c_find_connection_moves_line767_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        char distances_dataFileName[] = "/dataFile/readconnect.c_find_connection_moves_line767_1.distances.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/readconnect.c_find_connection_moves_line767_1.distances.dat does not exist!");
                exit(-1);
            }
