#include <hash.c_hashdata_invert_stone_line287_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <hash.c_hashdata_invert_stone_line287_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"hash.c_hashdata_invert_stone_line287_1.ptrderefout.hd", "hash.c_hashdata_invert_stone_line287_1.ptrderefout.st", "hash.c_hashdata_invert_stone_line287_1.ptrderefout.gl"};
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        char black_hash_dataFileName[] = "/dataFile/hash.c_hashdata_invert_stone_line287_1.black_hash.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/hash.c_hashdata_invert_stone_line287_1.black_hash.dat does not exist!");
                exit(-1);
            }
        ...
        char hd_hashval_dataFileName[] = "/dataFile/hash.c_hashdata_invert_stone_line287_1.hd_hashval.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/hash.c_hashdata_invert_stone_line287_1.hd_hashval.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
