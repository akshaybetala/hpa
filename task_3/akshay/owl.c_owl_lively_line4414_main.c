#include <owl.c_owl_lively_line4414_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <owl.c_owl_lively_line4414_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"owl.c_owl_lively_line4414_1.ptrderefout.hd", "owl.c_owl_lively_line4414_1.ptrderefout.st", "owl.c_owl_lively_line4414_1.ptrderefout.gl"};
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        /*----------------- read data for current_owl_data_lunch----------------------*/
        char current_owl_data_lunch_dataFileName[] = "/dataFile/owl.c_owl_lively_line4414_1.current_owl_data_lunch.dat";
        char current_owl_data_lunch_dataFileWithPath[256];
        sprintf (current_owl_data_lunch_dataFileWithPath, "%s/%s", argv[1], current_owl_data_lunch_dataFileName);
        int int_storage;

        if ( it < 1 )
        {
            pFile_ = fopen(current_owl_data_lunch_dataFileWithPath, "r");
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/owl.c_owl_lively_line4414_1.current_owl_data_lunch.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
                fscanf(pFile_,"%d", &int_storage);
                current_owl_data_lunch_[inputIndices[0]] = int_storage;
            }
            fclose(pFile_);
        }
        /*----------------- Read is done for current_owl_data_lunch------------------*/

        /*----------------- read data for current_owl_data_lunch_defense_point----------------------*/
        char current_owl_data_lunch_defense_point_dataFileName[] = "/dataFile/owl.c_owl_lively_line4414_1.current_owl_data_lunch_defense_point.dat";
        char current_owl_data_lunch_defense_point_dataFileWithPath[256];
        sprintf (current_owl_data_lunch_defense_point_dataFileWithPath, "%s/%s", argv[1], current_owl_data_lunch_defense_point_dataFileName);

        if ( it < 1 )
        {
            pFile_ = fopen(current_owl_data_lunch_defense_point_dataFileWithPath, "r");
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/owl.c_owl_lively_line4414_1.current_owl_data_lunch_defense_point.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
                fscanf(pFile_,"%d", &int_storage);
                current_owl_data_lunch_defense_point_[inputIndices[0]] = int_storage;
            }
            fclose(pFile_);
        }
        /*----------------- Read is done for current_owl_data_lunch_defense_point------------------*/
        ...
        memcpy(current_owl_data->lunch, current_owl_data_lunch_, sizeof(current_owl_data_lunch_));
        memcpy(current_owl_data->lunch_defense_point, current_owl_data_lunch_defense_point_, sizeof(current_owl_data_lunch_defense_point_));
