...
#include <value_moves.c_remove_top_move_line2698_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        char best_move_values_dataFileName[] = "/dataFile/value_moves.c_remove_top_move_line2698_1.best_move_values.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/value_moves.c_remove_top_move_line2698_1.best_move_values.dat does not exist!");
                exit(-1);
            }
        ...
        char best_moves_dataFileName[] = "/dataFile/value_moves.c_remove_top_move_line2698_1.best_moves.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/value_moves.c_remove_top_move_line2698_1.best_moves.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
