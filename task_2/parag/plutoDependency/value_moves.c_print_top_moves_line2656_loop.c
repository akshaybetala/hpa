...
[pluto] pluto_prog_constraints_lexmin (5 variables, 9 constraints)
[pluto] pluto_constraints_lexmin_isl (5 variables, 9 constraints)
...
t1 {loop with stmts: S1, S2, }
[Pluto] Output written to value_moves.c_print_top_moves_line2656_loop.pluto.c
