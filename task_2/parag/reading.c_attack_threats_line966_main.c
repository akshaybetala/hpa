#include <reading.c_attack_threats_line966_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <reading.c_attack_threats_line966_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"reading.c_attack_threats_line966_1.ptrderefout.hd", "reading.c_attack_threats_line966_1.ptrderefout.st", "reading.c_attack_threats_line966_1.ptrderefout.gl"};
    ...
    printf("\n");
    printf("Scalar num_threats: %d\n", num_threats);

    void* ptrCheckSumVal = dummy(1, codes);
