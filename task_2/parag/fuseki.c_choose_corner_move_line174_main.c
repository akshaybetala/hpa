#include <fuseki.c_choose_corner_move_line174_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <fuseki.c_choose_corner_move_line174_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"fuseki.c_choose_corner_move_line174_1.ptrderefout.hd", "fuseki.c_choose_corner_move_line174_1.ptrderefout.st", "fuseki.c_choose_corner_move_line174_1.ptrderefout.gl"};
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        memcpy(&sum_of_weights, &sum_of_weights_, sizeof(sum_of_weights_));
    ...
    printf("\n");
    printf("Scalar sum_of_weights: %d\n", sum_of_weights);
    printf("Scalar i: %d\n", i);

    void* ptrCheckSumVal = dummy(1, table);
