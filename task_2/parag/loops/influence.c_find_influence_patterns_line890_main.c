#include <influence.c_find_influence_patterns_line890_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <influence.c_find_influence_patterns_line890_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"influence.c_find_influence_patterns_line890_1.ptrderefout.hd", "influence.c_find_influence_patterns_line890_1.ptrderefout.st", "influence.c_find_influence_patterns_line890_1.ptrderefout.gl"};
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        /*----------------- read data for delta----------------------*/
        char delta_dataFileName[] = "/dataFile/influence.c_find_influence_patterns_line890_1.delta.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_find_influence_patterns_line890_1.delta.dat does not exist!");
                exit(-1);
            }
        ...
        /*----------------- read data for board----------------------*/
        char board_dataFileName[] = "/dataFile/influence.c_find_influence_patterns_line890_1.board.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_find_influence_patterns_line890_1.board.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
        ...
        char q_safe_dataFileName[] = "/dataFile/influence.c_find_influence_patterns_line890_1.q_safe.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_find_influence_patterns_line890_1.q_safe.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
        ...
        char q_white_permeability_dataFileName[] = "/dataFile/influence.c_find_influence_patterns_line890_1.q_white_permeability.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_find_influence_patterns_line890_1.q_white_permeability.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
        ...
        char q_black_permeability_dataFileName[] = "/dataFile/influence.c_find_influence_patterns_line890_1.q_black_permeability.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_find_influence_patterns_line890_1.q_black_permeability.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
