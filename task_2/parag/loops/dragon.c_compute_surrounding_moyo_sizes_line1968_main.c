...
#include <dragon.c_compute_surrounding_moyo_sizes_line1968_1.h>
#include <common.h>
#include <timer.h>
...
int pos;
float  moyo_sizes[20 * 20] = {0};
float  moyo_values[20 * 20] = {0};
...
int main(int argc, char** argv)
{
    ...
    {
        int moyo_values_dimension_sizes[1];
        int moyo_sizes_dimension_sizes[1];
    ...
    float fp_checksum_moyo_values = 0.0;
    for (int i0 = 0; i0 < 20 * 20; i0++)
    {
        fp_checksum_moyo_values += moyo_values[i0];
    }
    printf("f.p. array moyo_values: %f",fp_checksum_moyo_values);
    printf("\n");

    float fp_checksum_moyo_sizes = 0.0;
    for (int i0 = 0; i0 < 20 * 20; i0++)
    {
        fp_checksum_moyo_sizes += moyo_sizes[i0];
    }
    printf("f.p. array moyo_sizes: %f",fp_checksum_moyo_sizes);
    printf("\n");
