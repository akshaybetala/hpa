#include <influence.c_value_territory_line1238_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <influence.c_value_territory_line1238_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"influence.c_value_territory_line1238_1.ptrderefout.hd", "influence.c_value_territory_line1238_1.ptrderefout.st", "influence.c_value_territory_line1238_1.ptrderefout.gl"};
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        /*----------------- read data for board----------------------*/
        char board_dataFileName[] = "/dataFile/influence.c_value_territory_line1238_1.board.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_value_territory_line1238_1.board.dat does not exist!");
                exit(-1);
            }
        ...
        char q_safe_dataFileName[] = "/dataFile/influence.c_value_territory_line1238_1.q_safe.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_value_territory_line1238_1.q_safe.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
        ...
        char q_territory_value_dataFileName[] = "/dataFile/influence.c_value_territory_line1238_1.q_territory_value.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_value_territory_line1238_1.q_territory_value.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
        ...
        int q_non_territory_dimension_sizes[1];

        /*----------------- read data for q_non_territory----------------------*/
        char q_non_territory_dataFileName[] = "/dataFile/influence.c_value_territory_line1238_1.q_non_territory.dat";
        char q_non_territory_dataFileWithPath[256];
        sprintf (q_non_territory_dataFileWithPath, "%s/%s", argv[1], q_non_territory_dataFileName);
        int int_storage;

        if ( it < 1 )
        {
            pFile_ = fopen(q_non_territory_dataFileWithPath, "r");
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_value_territory_line1238_1.q_non_territory.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
                fscanf(pFile_,"%d", &int_storage);
                q_non_territory_[inputIndices[0]] = int_storage;
            }
            fclose(pFile_);
        }
        /*----------------- Read is done for q_non_territory------------------*/
        ...
        memcpy(q->non_territory, q_non_territory_, sizeof(q_non_territory_));
