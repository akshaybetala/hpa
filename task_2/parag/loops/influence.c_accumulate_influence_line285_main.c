...
#include <influence.c_accumulate_influence_line285_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        char working_dataFileName[] = "/dataFile/influence.c_accumulate_influence_line285_1.working.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_accumulate_influence_line285_1.working.dat does not exist!");
                exit(-1);
            }
        ...
        char permeability_array_dataFileName[] = "/dataFile/influence.c_accumulate_influence_line285_1.permeability_array.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_accumulate_influence_line285_1.permeability_array.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
        ...
        char deltaj_dataFileName[] = "/dataFile/influence.c_accumulate_influence_line285_1.deltaj.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_accumulate_influence_line285_1.deltaj.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
        ...
        char deltai_dataFileName[] = "/dataFile/influence.c_accumulate_influence_line285_1.deltai.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_accumulate_influence_line285_1.deltai.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
        ...
        /*----------------- read data for safe----------------------*/
        char safe_dataFileName[] = "/dataFile/influence.c_accumulate_influence_line285_1.safe.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_accumulate_influence_line285_1.safe.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
        ...
        /*----------------- read data for delta----------------------*/
        char delta_dataFileName[] = "/dataFile/influence.c_accumulate_influence_line285_1.delta.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_accumulate_influence_line285_1.delta.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
        ...
        /*----------------- read data for board----------------------*/
        char board_dataFileName[] = "/dataFile/influence.c_accumulate_influence_line285_1.board.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/influence.c_accumulate_influence_line285_1.board.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
