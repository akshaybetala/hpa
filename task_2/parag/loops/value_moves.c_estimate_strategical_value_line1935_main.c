...
#include <value_moves.c_estimate_strategical_value_line1935_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    {
        int dragon_value_dimension_sizes[1];
    ...
    float fp_checksum_dragon_value = 0.0;
    for (int i0 = 0; i0 < 20 * 20; i0++)
    {
        fp_checksum_dragon_value += dragon_value[i0];
    }
    printf("f.p. array dragon_value: %f",fp_checksum_dragon_value);
    printf("\n");
