...
#include <surround.c_compute_surroundings_line221_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        char right_corner_dataFileName[] = "/dataFile/surround.c_compute_surroundings_line221_1.right_corner.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/surround.c_compute_surroundings_line221_1.right_corner.dat does not exist!");
                exit(-1);
            }
        ...
        char left_corner_dataFileName[] = "/dataFile/surround.c_compute_surroundings_line221_1.left_corner.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/surround.c_compute_surroundings_line221_1.left_corner.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
