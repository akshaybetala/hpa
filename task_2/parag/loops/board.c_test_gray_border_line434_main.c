...
#include <board.c_test_gray_border_line434_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        /*----------------- read data for board----------------------*/
        char board_dataFileName[] = "/dataFile/board.c_test_gray_border_line434_1.board.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/board.c_test_gray_border_line434_1.board.dat does not exist!");
                exit(-1);
            }
