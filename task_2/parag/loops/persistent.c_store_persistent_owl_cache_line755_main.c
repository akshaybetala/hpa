...
#include <persistent.c_store_persistent_owl_cache_line755_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        /*----------------- read data for goal----------------------*/
        char goal_dataFileName[] = "/dataFile/persistent.c_store_persistent_owl_cache_line755_1.goal.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/persistent.c_store_persistent_owl_cache_line755_1.goal.dat does not exist!");
                exit(-1);
            }
        ...
        /*----------------- read data for board----------------------*/
        char board_dataFileName[] = "/dataFile/persistent.c_store_persistent_owl_cache_line755_1.board.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/persistent.c_store_persistent_owl_cache_line755_1.board.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
