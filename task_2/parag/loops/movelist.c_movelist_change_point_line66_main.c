#include <movelist.c_movelist_change_point_line66_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <movelist.c_movelist_change_point_line66_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"movelist.c_movelist_change_point_line66_1.ptrderefout.hd", "movelist.c_movelist_change_point_line66_1.ptrderefout.st", "movelist.c_movelist_change_point_line66_1.ptrderefout.gl"};
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        memcpy(&max_points, &max_points_, sizeof(max_points_));
    ...
    void* ptrCheckSumVal = dummy(1, points);
