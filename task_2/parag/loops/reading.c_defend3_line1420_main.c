...
#include <reading.c_defend3_line1420_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        /*----------------- read data for libs----------------------*/
        char libs_dataFileName[] = "/dataFile/reading.c_defend3_line1420_1.libs.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/reading.c_defend3_line1420_1.libs.dat does not exist!");
                exit(-1);
            }
