...
#include <reading.c_attack4_line3043_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        char moves_score_dataFileName[] = "/dataFile/reading.c_attack4_line3043_1.moves_score.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/reading.c_attack4_line3043_1.moves_score.dat does not exist!");
                exit(-1);
            }
