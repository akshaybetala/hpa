#include <owl.c_owl_update_goal_line3481_1.ptrderefout.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <limits.h>
...
#include <owl.c_owl_update_goal_line3481_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    static char* inputDataFileName[] = {"owl.c_owl_update_goal_line3481_1.ptrderefout.hd", "owl.c_owl_update_goal_line3481_1.ptrderefout.st", "owl.c_owl_update_goal_line3481_1.ptrderefout.gl"};
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        char stones_dataFileName[] = "/dataFile/owl.c_owl_update_goal_line3481_1.stones.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/owl.c_owl_update_goal_line3481_1.stones.dat does not exist!");
                exit(-1);
            }
        ...
        char owl_goal_dataFileName[] = "/dataFile/owl.c_owl_update_goal_line3481_1.owl_goal.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/owl.c_owl_update_goal_line3481_1.owl_goal.dat does not exist!");
                exit(-1);
            }
            while(fscanf(pFile_, "%d", &inputIndices[0]) != EOF)
            {
