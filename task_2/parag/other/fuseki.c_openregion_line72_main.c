...
#include <fuseki.c_openregion_line72_1.h>
#include <common.h>
#include <timer.h>
...
int main(int argc, char** argv)
{
    ...
    for (int it = 0; it < iterations; it++)
    {
        ...
        /*----------------- read data for board----------------------*/
        char board_dataFileName[] = "/dataFile/fuseki.c_openregion_line72_1.board.dat";
        ...
        if ( it < 1 )
        {
            ...
            if (pFile_ == NULL)
            {
                printf("data file: /dataFile/fuseki.c_openregion_line72_1.board.dat does not exist!");
                exit(-1);
            }
        ...
        memcpy(&j2, &j2_, sizeof(j2_));
        memcpy(&j1, &j1_, sizeof(j1_));
        memcpy(&i2, &i2_, sizeof(i2_));
        memcpy(&i1, &i1_, sizeof(i1_));
