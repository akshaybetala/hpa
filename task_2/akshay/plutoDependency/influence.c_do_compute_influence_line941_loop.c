...
nvar = 1, npar = 0
Parameters: 
S1 "int_white_permeabilities[ii] =(((int )(q -> white_permeability[ii] *(1 << 12))) + 0.5);"
...
q[4][ii]
Write accesses
int_white_permeabilities[ii]
Original loop: 0 -> yes

S2 "int_black_permeabilities[ii] =(((int )(q -> black_permeability[ii] *(1 << 12))) + 0.5);"
ndims: 1; orig_depth: 1
Index set
Set #1
[1 dims; 2 constraints]
...
t1 {loop with stmts: S1, S2, }
[Pluto] Output written to influence.c_do_compute_influence_line941_loop.pluto.c
